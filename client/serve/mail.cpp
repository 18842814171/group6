...
int mail(string mail1, string str1)
{
    ...
    while (1)
    {
        ...
        //else
        //{
        pHostent = gethostbyname("smtp.163.com"); //得到有关于域名的信息,链接到163邮箱服务器
        //}
        ...
        */
        ...
        string Swd;
        Swd = "SHGPWYENUGYBULQM";
        /*cout << "请输入您的授权码：";
        cin >> Swd;*/
        message = base64(Swd) + "\r\n";//base64 编码的密码
        send(sockClient, message.c_str(), message.length(), 0);
        buff[recv(sockClient, buff, 500, 0)] = '\0';
        /*std::cout << "password:" << buff << endl;*/
        ...
        //cout << "主题：";
        //cin >> subject;
        subject = "Your order is alarming!!!";
